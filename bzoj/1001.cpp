...
void build_graph()
{
    ...
    for (int i = 1; i <= n; i++)
    {
        for (int j = 1; j < m; j++)
        {
            ...
            add_edge(m*(i-1)+j+1, m*(i-1)+j, 0);
            add_edge(m*(i-1)+j, m*(i-1)+j+1, 0);
    ...
    for (int i = 1; i < n; i++)
    {
        for (int j = 1; j <= m; j++)
        {
            ...
            add_edge(m*i+j, m*(i-1)+j, 0);
            add_edge(m*(i-1)+j, m*i+j, 0);
    ...
    for (int i = 1; i < n; i++)
    {
        for (int j = 1; j < m; j++)
        {
            ...
            add_edge(m*i+j+1, m*(i-1)+j, 0);
            add_edge(m*(i-1)+j, m*i+j+1, 0);
